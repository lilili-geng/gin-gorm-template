...
import (
	"template-project/app/admin/controller"
	monitorcontroller "template-project/app/admin/controller/monitor"
	systemcontroller "template-project/app/admin/controller/system"
...
func RegisterAdminGroupApi(api *gin.RouterGroup) {
	...
	api.Use(middleware.AuthAdminMiddleware())
