...
import (
	...
	"strconv"
	"strings"
	"template-project/app/admin/dto"
	"template-project/app/admin/security"
	"template-project/app/admin/service"
	"template-project/app/admin/validator"
	"template-project/common/password"
	"template-project/common/upload"
	"template-project/common/utils"
...
func (*UserController) ImportData(ctx *gin.Context) {
	...
	fileName := config.Data.Lili.UploadPath + file.Filename
